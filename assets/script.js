...
// // Supprime la classe 'dot_selected' de tous les dots
// let dotsList = dots.querySelectorAll('.dot');
// dotsList.forEach((dot) => {
//   dot.classList.remove('dot_selected');
// });

// // Ajoute la classe 'dot_selected' au dot correspondant à la slide active
// let activeDot = dotsList[currentSlide];
